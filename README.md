...
<h5 align="left"  color="black">About "building from the scratch" experience - At on one of my projecta I have developed **from the scratch** a high-efficient modern cloud-based CI-CD system with automated testing, integrated to project control tools (like Jira, Test Rail, Confluence) and communication tools (like MS Teams, e-mail, Telegram, Skype, etc..). </h6>
